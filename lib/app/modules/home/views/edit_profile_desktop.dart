...
class _EditProfileDesktopState extends ModularState<EditProfileDesktop, HomeStore> {
  final HomeStore _controller = Modular.get();

  @override
  void initState() {
    _controller.resetUser();
                          ...
                          children: [
                            FadeInDown(
                              ...
                              child: TextButton(
                                ...
                                onPressed: () async {
                                  if(_controller.updateNameController.text.isNotEmpty &&
                                    ...
                                    await _controller.EditarUser();
                                    if(_controller.resultEditUsuario==true){
                                      await controller.getCurrentUser();
                                      Modular.to.navigate("/home");
                                    }
                                  }else{
                                    Fluttertoast.showToast(msg: 'PREENCHA TODOS OS DADOS PARA CONCLUIR A EDIÇÃO');
                                  }
                                },
                              ),
                            ),
